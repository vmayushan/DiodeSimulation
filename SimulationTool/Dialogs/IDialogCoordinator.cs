...
namespace SimulationTool.Dialogs
{
    /// <summary>
    ...
    public interface IDialogCoordinator
    {
        ...
        /// </summary>
        /// <param name="context">Typically this should be the view model, which you register in XAML using <see cref="SimulationTool.Dialogs.DialogParticipation.SetRegister"/>.</param>
